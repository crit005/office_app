...
class ItemReport extends Component
{
    ...
    public function mount($title='Item Report',$search)
    {
        $this->search = $search;
        $this->title = $title;
    ...
    {
        return view('livewire.components.transaction.item-report',['trCashs'=>$this->getItemTransaction()]);
    }
}
