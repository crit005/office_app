                                        ...
                                        <tr>
                                            ...
                                            {{-- <td class="text-center">
                                                <div class="d-flex justify-content-center pt-1">
                                                    <div class="{{$currency->getStatusBage()}}"></div>
                                                </div>
                                            </td> --}}

                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <button class="btn btn-xs btn-primary mr-2" wire:click.prevent="edit({{$currency}})"><i class="fa fa-edit"></i>
                                                    </button>
                                                
                                                    <button class="btn btn-xs btn-danger mr-2" wire:click.prevent="confirmTrash({{$currency}})">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                
                                                    @if (Auth()->user()->isAdmin())
                                                    <button class="btn btn-xs btn-danger" wire:click.prevent="confirmUserRemoval({{$currency->id}})">
